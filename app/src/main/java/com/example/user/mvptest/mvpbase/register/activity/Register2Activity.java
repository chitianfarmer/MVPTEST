...
import com.example.user.mvptest.mvpbase.register.presenter.RegisterPrestener;
 ...
 * 邮箱:814326663@qq.com
 */
public class Register2Activity extends BaseActivity implements RegisterContract.View, View.OnClickListener {
    private EditText mobile, firstPwd, secondPwd, smsCode;
    private Button registerButton, smsCodeButton;
    private RegisterContract.Prestener pasenter;
    ...
    private void initData() {
        pasenter = new RegisterPrestener(this);//中间层pastener数据绑定view
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_smsCode:
                ...
                pasenter.sendSmsCode(getMobile());
                break;
            case R.id.btn_register:
                pasenter.register(getMobile(), getPassword(), getConfirmPwd(), getSmsCode());
                break;
        }
    }
    ...
    public String getSmsCode() {
        return smsCode.getText().toString().trim();
    }
